 ...
 */
public class ExampleClientThatLocks3 {
    ...
    public ExampleClientThatLocks3(CuratorFramework client, String lockPath, FakeLimitedResource resource, String clientName) {
