		...
		<div id="list_bottom">
			...
			<form name="addblogForm" method="post" action="AddBlog">
			  <table width="570" border="0">
			    <tr>
			      <td width="95">文章标题：</td>
			      <td colspan="3" ><input type="text" name="blog_subject" size="65" style="border: #E97B56 solid 1px;"/></td>
			    </tr>
			    <tr>
			      <td>&nbsp;</td>
			      <td colspan="3"><textarea name="blog_content" class="content" cols="48" rows="20" style="border: #E97B56 solid 1px;"></textarea></td>
			    </tr>
			    <tr>
			      <td>文章类别：</td>
			      <td width="165">
			      ...
			      <td width="85"><a href='javascript:showText()'>新建分类</a></td>
			      <td width="221"><a id='create_class'></a></td>
			    </tr>
			    <tr>
			      <td colspan="4">
				      <input type="submit" value="发表" style="font-size: 24px;width: 110px;height:40px;margin-top:20px;padding:0 10px;margin-left:85px;margin-right:10px;font-weight: bold;font-family:微软雅黑;">
				      <input type="reset" value="取消" style="font-size: 24px;width: 110px;height:40px;margin-top:20px;padding:0 10px;margin-right:10px;font-weight: bold;font-family:微软雅黑;"/>
