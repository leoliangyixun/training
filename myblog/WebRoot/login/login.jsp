				...
				<form name="loginForm" method="post" action="../LoginCheck">
					<table width="220" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="220"><input name="username" type="text" class="input" id="account" size="25"  onfocus="clearLoginText()"/></td>
						</tr>
						<tr>
							<td height="30">密&nbsp;&nbsp;&nbsp;码：</td>
							<td><input name="password" type="text" class="input" id="password" size="25" onfocus="clearLoginText()"/></td>	
						</tr>
						<tr>
