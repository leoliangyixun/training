		...
		<div id="list_bottom">
			<div id="blog_list">
				<div id="link_list_style">
				    <a href="blog_list.jsp" >我的文章</a>
					<a href="blog_private_list.jsp">私密日志</a>
					<a href="blog_draft_list.jsp" style="background-color:#E97B56;">草稿箱</a>
				</div>
				<%
					...
					if(draft_blog!=null && draft_blog.size()>0)
					{
						...
						int pagestep=5;
						countpage=PagingUtil.getCountpage(draft_blog.size(), pagesize);
						countstep=PagingUtil.getCountstep(draft_blog.size(), pagesize, pagestep);
						...
						for (int i = (currpage-1)*pagesize;i < currpage*pagesize; i++) 
						{
							if(i<draft_blog.size())
							{
								...
								out.println("<tr><td align='left' width='80' style='font-size:12px'>【"+blog_class+"】</td>"
										   ...
										   +Constants.BLOG_FOR_DRAFT+"&blog_link_mark="+Constants.BLOG_LINK_MARK_DRAFT+"'>" +blog_subject+"</a>["+new SimpleDateFormat("yyyy-MM-dd").format(blog_date)+"]</td>" 
