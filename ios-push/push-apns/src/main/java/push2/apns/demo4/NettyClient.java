...
public class NettyClient {
    ...
    public void build() throws Exception {
        strap.group(group).channel(NioSocketChannel.class).option(ChannelOption.TCP_NODELAY, true)
            .option(ChannelOption.SO_KEEPALIVE, true)/*.handler(new NettyClientHander())*/;
    ...
    public static class NettyChannelPoolHandler  implements ChannelPoolHandler {
        @Override
    ...
    public static class NettyClientHander extends ChannelInboundHandlerAdapter {
