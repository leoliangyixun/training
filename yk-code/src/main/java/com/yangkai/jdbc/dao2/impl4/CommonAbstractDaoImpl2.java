...
public abstract class CommonAbstractDaoImpl2 {
	
	public Object commonFind(String sql,Object[] args,ObjectMapper mapper)
	{
	...
	public List<Object> commonListFind(String sql,Object[] object,ObjectMapper mapper)
	{
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs=null;
