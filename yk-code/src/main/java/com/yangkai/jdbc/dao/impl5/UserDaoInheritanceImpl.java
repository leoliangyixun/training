...
public class UserDaoInheritanceImpl extends CommonAbstractTemplate implements UserDao{
	...
	public User findUserById(int id) {
		...
		Object[] args={id};
		User user=super.find(sql, args,new Mapper() {
	...
	public String findUserName(int id) {
		...
		Object[] args={id};
		String name=super.find(sql, args,new Mapper() {
			@SuppressWarnings("unchecked")
			@Override
