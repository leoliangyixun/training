		...
		<div id="list_bottom">
			<div id="blog_list">
				<div id="link_list_style">
				    <a href="blog_list.jsp" style="background-color:#E97B56;">已发表博文列表</a>
			...
			<%
			 if(user_blog!=null && user_blog.size()>0)
			 {
			     ...
			     int pagestep=5;
			     countpage=PagingParamTool.getCountpage(user_blog.size(), pagesize);
			     countstep=PagingParamTool.getCountstep(user_blog.size(), pagesize, pagestep);
