		...
		<div id="list_bottom">
			<div id="blog_list">
				<div id="link_list_style">
					...
					<a href="blog_private_list.jsp" style="background-color:#E97B56;">私密日志</a>
						...
						for (int i = (currpage-1)*pagesize;i < currpage*pagesize; i++) 
						{
							if(i<private_blog.size())
							{
								...
								out.println("<tr><td align='left' width='80' style='font-size:12px'>【"+blog_class+"】</td>"
										   ...
										   +Constants.BLOG_FOR_PRIVATE+"&blog_link_mark="+Constants.BLOG_LINK_MARK_PRIVATE+"'>" +blog_subject+"</a>["+new SimpleDateFormat("yyyy-MM-dd").format(blog_date)+"]</td>" 
