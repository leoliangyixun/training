		...
		<div id="list_bottom">
			<div id="blog_list">
				<div id="link_list_style">
				    ...
				    <a href="my_friends_album.jsp" style="background-color:#E97B56;">好友相册</a>
		        </div>
				<%
								...
								{	
									...
									if(index<friends.size())
									{
										...
										*/
										...
										out.println("<tr><td style='font-size:12px' width='250'><img src='upload/相册/"+username+"/image/me.jpg' width='60' height='60'/></br>"
												   +"好友：<a style='color:red;'>"+username+"</a></br></td>");
