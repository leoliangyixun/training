...
public class AddBlogCommentReply extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String blog_comment_reply_content=EncoderUtil.encode(request.getParameter("blog_comment_reply_content"));
		...
		String blog_comment_reply_content=CharactorEncoder.setCharacterEncoding(request.getParameter("blog_comment_reply_content"));
