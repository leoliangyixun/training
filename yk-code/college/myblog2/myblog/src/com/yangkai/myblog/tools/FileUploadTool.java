...
public class FileUploadTool {
	...
	public FileUploadTool( HttpServletRequest request,long maxsize ) //构造方法。
	{
	...
	public Map<String,String> saveAll(String savePath) //保存上传的文件到指定文件夹。
	{
		...
		if(files.size()>0)
		{
			...
			{	
				...
				String fileName=new FileRenameTool(new Date()).getFileName(this.request.getRemoteAddr())
