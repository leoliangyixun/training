...
public class UserRegist extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sex=EncodingTool.setCharacterEncoding(request.getParameter("sex"));
		String address=EncodingTool.setCharacterEncoding(request.getParameter("address"));
		...
		System.out.println("UserRegist:"+service);
