...
public class AddBlogComment extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String guest=EncodingTool.setCharacterEncoding(request.getParameter("guest"));//获取评论人用户名。
		String blog_comment_content=EncodingTool.setCharacterEncoding(request.getParameter("blog_comment_content"));//获取评论内容。
		...
		System.out.println("AddBlogComment:"+service);
