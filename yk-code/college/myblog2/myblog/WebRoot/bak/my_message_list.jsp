		...
		<div id="list_bottom">
			<div id="blog_list">
				<div id="message_style">
					<a href="my_message.jsp">给我的留言</a>
					<a href="my_leave_message.jsp">我写的留言</a>
					<a href="my_leave_message_friends.jsp">给好友留言</a>
					<a href="my_message_list.jsp" style="background-color:#E97B56;">留言管理</a>
				</div>
				<%
				...
				if(user_message!=null && user_message.size()>0)
				{
					...
					out.println("<tr style='font-size:14px;'><td width='150'>留言人</td ><td>留言摘要</td><td width='80' align='center'>留言时间</td><td width='120' align='center'>留言操作</td></tr>");
					for (int i = (currpage-1)*pagesize;i < currpage*pagesize; i++) 
					{
						if(i<user_message.size())
						{
							...
							out.println("<tr><td><a>"+guest+"</a></td>"
							           ...
							           +"<td><span><a href='message_view.jsp?message_id="+message_id+"'>查看</a><a href='#'>回复</a><a href='javascript:deleteMessageBox("+message_id+","+currpage+","+currstep+")'>删除</a></span></td></tr>");
						}
					}
					out.println("</table>");
					out.println("</div>");
