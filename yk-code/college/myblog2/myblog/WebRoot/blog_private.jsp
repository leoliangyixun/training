...
<div>
	<ul>
		 ...
		 <li class="current_page_item"><a href="blog_private.jsp">私密日志</a></li>	
				    	...
				    	for (int i = (currpage-1)*pagesize; i < currpage*pagesize; i++) 
				    	{
					    	if(i<private_blog.size())
					    	{
						         ...
						         out.println("<div align='left' class='link_style'><a>发表时间："
						         			 ...
						         			 +Constants.BLOG_FOR_PRIVATE+"&blog_link_mark="+Constants.BLOG_LINK_MARK_PRIVATE+"'>查看</a><a href='blog_edit.jsp?blog_id="+blog_id+"&mark="
								         			 +Constants.BLOG_FOR_PRIVATE+"&blog_link_mark="+Constants.BLOG_LINK_MARK_PRIVATE+"'>编辑</a>"
						                     + "<a href='DeleteBlog?blog_id="+blog_id+"&mark="+Constants.BLOG_FOR_PRIVATE+"'>删除</a><a href='AlterBlogState?blog_id="+blog_id+"&type="+Constants.BLOG_FOR_PRIVATE+"'>转为普通日志</a></span>");
						         out.println("</div>");
					    	}
