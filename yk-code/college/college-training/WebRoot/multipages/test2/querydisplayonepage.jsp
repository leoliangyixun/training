...
<jsp:useBean id="p" class="com.yangkai.bean.MSSQLServerDataMultipages" scope="session"></jsp:useBean>
...
<html>
  ...
  <body>
  <div align="center">
   <form action="querydisplayonepage.jsp" method="get" >
   ...
   <input type="submit" value="查询"/>
    ...
    //String name=p.setCharacterEncoding(request.getParameter("bookname"));
      if(name==null||name.equals("")||p.setCharacterEncoding(name).equals("请输入图书信息"))//这里的判断形式很重要。
     //if(name==null||name.equals("")||p.setCharacterEncoding(name)=="请输入图书信息")//这里不能用"=="号，基本数据类型可以用"=="号，引用类型最好用"equals",一般不用"=="号
      {
    		out.println("");
      }
